...
public class RetrievePDFEnglish extends AppCompatActivity {
    ...
    private void retrievePDFFiles() {
        ...
        englishReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                PDFListAdapter adapter = new PDFListAdapter(RetrievePDFEnglish.this, pdfList);
                listView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(RetrievePDFEnglish.this, "Помилка: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
