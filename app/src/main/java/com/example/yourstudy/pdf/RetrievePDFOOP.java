...
public class RetrievePDFOOP extends AppCompatActivity {
    ...
    private void retrievePDFFiles() {
        ...
        OOPReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                PDFListAdapter adapter = new PDFListAdapter(RetrievePDFOOP.this, pdfList);
                listView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(RetrievePDFOOP.this, "Помилка: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
