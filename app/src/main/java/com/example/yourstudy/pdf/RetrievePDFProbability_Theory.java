...
public class RetrievePDFProbability_Theory extends AppCompatActivity {
    ...
    private void retrievePDFFiles() {
        ...
        englishReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                PDFListAdapter adapter = new PDFListAdapter(RetrievePDFProbability_Theory.this, pdfList);
                listView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(RetrievePDFProbability_Theory.this, "Помилка: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
