...
public class RetrievePDFProgramming_Technology extends AppCompatActivity {
    ...
    private void retrievePDFFiles() {
        ...
        programmingReference.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                PDFListAdapter adapter = new PDFListAdapter(RetrievePDFProgramming_Technology.this, pdfList);
                listView.setAdapter(adapter);
            }

            @Override
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(RetrievePDFProgramming_Technology.this, "Помилка: " + databaseError.getMessage(), Toast.LENGTH_SHORT).show();
            }
        });
    }
}
